...
<head>
    <title>Stiker Pemegang Aset</title>
                    ...
                    <div class="row">
                            ...
                            <table id="example1" class="">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width=150px;>: {{ $p->barang->kode_barang }}</td>
                                    </tr>
                                    <tr>
                                        <td width=75px;>Nama Barang</td>
                                        <td width=150px;>: {{ $p->barang->nama_barang }}</td>
                                    </tr>
                                    <tr>
                                        <td width=75px;>Merk / Type</td>
                                        <td width=150px;>: {{ $p->barang->merktype }}</td>
                                    </tr>
                                    <tr>
                                        <td width=75px;>Tahun</td>
                                        <td width=150px;>: {{ $p->barang->tahun }}</td>
                                    </tr>
                                    <tr>
                                        <td width=75px;>Asal</td>
                                        <td width=150px;>: {{ $p->barang->asal }}</td>
                                    </tr>
                                    {{-- @if ($nama != null) --}}
                                    <tr>
                                        <td width=75px;>Pemegang</td>
                                        <td width=150px;>: {{ $p->karyawan->nama }}</td>
                                    </tr>
                                    {{-- @endif --}}
                                </tbody>
                            </table>
                        ...
                        <div class="col-sm-3">
                            <table id="example1" class="">
                                <tbody>
                                    <tr>
                                        <td> {{ QrCode::size(120)->generate($p->barang->kode) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
